...
import { ERC725YSchemaTable } from '../../libs/database/lukso-structure/entities/erc725YSchema.table';
import { ContractInterfaceTable } from '../../libs/database/lukso-structure/entities/contractInterface.table';
